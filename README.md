...
3. 如果要把方法落地到新项目，读 [`docs/coding-agents/playbooks/workflows/new-project-bootstrap.md`](docs/coding-agents/playbooks/workflows/new-project-bootstrap.md)。
4. 如果要接入既有项目，读 [`docs/coding-agents/playbooks/workflows/existing-project-onboarding.md`](docs/coding-agents/playbooks/workflows/existing-project-onboarding.md)。
...
10. 如果要理解 Prompt Engineering 如何从提示词技巧演化到 context、eval 和 harness，读 [`docs/harness-engineering/layers/06-prompt-engineering-research.md`](docs/harness-engineering/layers/06-prompt-engineering-research.md)。
11. 如果要理解 Tool Use 如何从函数调用演化为 agent action layer，读 [`docs/harness-engineering/layers/07-tool-use-research.md`](docs/harness-engineering/layers/07-tool-use-research.md)。
12. 如果要理解 Agent Loop 如何从 ReAct 循环演化到生产级 agent runtime，读 [`docs/harness-engineering/layers/08-agent-loop-research.md`](docs/harness-engineering/layers/08-agent-loop-research.md)。
13. 如果要理解 Context Engineering 如何治理 agent 每一步能看到什么，读 [`docs/harness-engineering/layers/09-context-engineering-research.md`](docs/harness-engineering/layers/09-context-engineering-research.md)。
14. 如果要理解 Agent Planning 如何从 prompt 技巧变成 harness 控制面，读 [`docs/harness-engineering/layers/10-planning-research.md`](docs/harness-engineering/layers/10-planning-research.md)。
...
18. 如果要把 Vibe Coding 的判断落实成可复制 prompt，读 [`docs/coding-agents/playbooks/workflows/learning-first-vibe-coding.md`](docs/coding-agents/playbooks/workflows/learning-first-vibe-coding.md)。
19. 如果要研究 Codex CLI 实验 Memories 功能，读 [`docs/coding-agents/codex/memory/01-codex-cli-experimental-memories.md`](docs/coding-agents/codex/memory/01-codex-cli-experimental-memories.md)。
20. 如果要理解 LLM API 如何进入生产系统，读 [`docs/llm-api/research/01-llm-api-research.md`](docs/llm-api/research/01-llm-api-research.md)。
21. 如果要理解 reasoning、模型能力和 benchmark，再读 [`docs/ai-models/README.md`](docs/ai-models/README.md) 下的文档。
22. 如果要理解长上下文、prompt caching 和 agent runtime 成本，再读 [`docs/ai-models/infrastructure/05-kv-cache-research.md`](docs/ai-models/infrastructure/05-kv-cache-research.md)。
