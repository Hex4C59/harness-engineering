...
这里放模型代码能力、reasoning、test-time compute 和能力形成机制相关文档。
...
- [`../evaluation/README.md`](../evaluation/README.md)：模型 benchmark 和报告解读。
- [`../infrastructure/README.md`](../infrastructure/README.md)：推理和 runtime 基础设施。
