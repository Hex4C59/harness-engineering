...
这里放 coding agent runtime 机制调研：memory、sandbox、hooks、skills，以及这些机制如何共同影响可靠性、安全和上下文管理。

文档：

1. [`01-coding-agent-memory-mechanisms.md`](01-coding-agent-memory-mechanisms.md)：Coding Agent 记忆机制综述。
