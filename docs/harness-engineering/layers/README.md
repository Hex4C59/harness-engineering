...
这里按 harness 的关键层次收纳专题调研：prompt、tool use、agent loop、context 和 planning。
...
- [`../foundations/README.md`](../foundations/README.md)：harness engineering 基础概念。
- [`../../coding-agents/research/runtime/README.md`](../../coding-agents/research/runtime/README.md)：coding agent runtime 机制。
